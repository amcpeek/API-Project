...
//#21
export const addSpotBooking = (spotBooking, id) => async (dispatch) => {
  //booking info + spotId
...
export const updateSpotBooking =
  (newBooking, sendBookingId) => async (dispatch) => {
