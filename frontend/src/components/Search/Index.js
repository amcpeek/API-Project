            ...
            <div>
              ...
              <div>
                <form onSubmit={handleSubmitPrice} className="centerDiv">
                  <div
                    style={{ width: "32rem", padding: "20px" }}
                    className="range"
                  >
                    <Slider
                      value={range}
                  ...
                  <button type="submit" className="inDevelopment">
                    Search
                  </button>
                </form>
              </div>
      ...
      <div className="justSize">
        ...
        <div className="chooseGuests">
          <label>
            ...
            >
              <option key="1 guest" value="1 guest">
                {" "}
                1 adult
              </option>
              <option key="2 guests" value="2 guests">
                {" "}
                2 adults
              </option>
              <option key="3 guests" value="3 guests">
                {" "}
                3 adults
              </option>
              <option key="4 guests" value="4 guests">
                {" "}
                4 adults
              </option>
              <option key="5 guests" value="5 guests">
                {" "}
                5 adults
              </option>
            </select>
