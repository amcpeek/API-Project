...
const UpdateSpotForm = ({ showModal, setShowModal }) => {
  ...
  useEffect(() => {
    ...
    if (spot) {
      ...
      setImageFile(
        spot.url ||
          "https://i.pinimg.com/originals/2a/43/d6/2a43d625d02deb3c0b1179eac7f2256e.jpg"
      );
      // setPreview(false)
    }
  ...
  if (!spot) {
    return <div>This form is not available</div>;
  }
  return (
    <div className="realModalOutside">
      <div className="realModalContent">
        ...
        <form onSubmit={handleSubmit} className="CreateSpotForm roundAllFields">
          <div className="labelForForm">Name</div>
          <div>
            <input
              type="text"
          ...
          <div className="labelForForm">Address</div>
          <div>
            <input
              type="text"
          ...
          <div className="labelForForm">City</div>
          <div>
            <input
              type="text"
          ...
          <div className="labelForForm">State</div>
          {/* <div>
          ...
          <div className="labelForForm">Country</div>
          <div>
            <input
              type="text"
          ...
          <div className="labelForForm">Description</div>
          <div>
            <textarea
          ...
          <div className="labelForForm">Price</div>
          <div>
            <input
              type="number"
              placeholder="Price"
          ...
          <div className="flexStart">
            <div className="labelForForm">Attach your image file below.</div>
          </div>
